...
- [x] LBM-016: P1 Promote adapter-fetched metadata into model metadata with source precedence
  ...
  - Completed: 2026-07-01. Chatbot Arena and verified IFEval metadata now fill missing provider, context, pricing, license, documentation URL, and metadata-source fields without overwriting existing OpenRouter, Hugging Face, or curated values.
