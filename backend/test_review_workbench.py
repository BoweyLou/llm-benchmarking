...
class ReviewWorkbenchTests(unittest.TestCase):
    ...
    def test_review_app_and_catalog_are_readable(self) -> None:
        ...
        self.assertIn("Production ranked", app_response.text)
        self.assertIn("Under-tested", app_response.text)
        self.assertIn("sparse_rankings", app_response.text)
        self.assertIn("rankingStatusLabel", app_response.text)
