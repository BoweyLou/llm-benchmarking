...
class ReviewWorkbenchTests(unittest.TestCase):
    ...
    def test_review_app_and_catalog_are_readable(self) -> None:
        ...
        self.assertIn("selectRankingPage", app_response.text)
        self.assertIn("Select ranked page", app_response.text)
        self.assertIn("selectedRankingModelIds", app_response.text)
        self.assertIn("applyRankingBulk", app_response.text)
