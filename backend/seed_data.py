...
USE_CASES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "icon": "🔎",
        "description": "Proxy lens for retrieval sorting, context ranking, and answer shaping around retrieved context",
        "segment": "enterprise",
        "status": "preview",
        "min_coverage": 0.55,
        "required_benchmarks": ["chatbot_arena", "ifeval"],
        "benchmark_notes": {
            "aa_intelligence": "Proxy for general knowledge-work quality, not grounded retrieval accuracy.",
            "gpqa_diamond": "Reasoning proxy for selecting relevant retrieved context, not a groundedness benchmark.",
            "ifeval": "Instruction fidelity for organizing, ranking, and shaping retrieved context.",
            "chatbot_arena": "Answer quality after retrieval is assembled, not retrieval correctness itself.",
        },
        "weights": {
            "aa_intelligence": 0.35,
            "gpqa_diamond": 0.25,
            "ifeval": 0.20,
            "chatbot_arena": 0.20,
        },
