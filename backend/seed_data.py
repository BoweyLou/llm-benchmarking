...
BENCHMARKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "higher_is_better": 1,
        "tier": 2,
        "scraper_id": "ArtificialAnalysisIfbenchAdapter",
        "description": "Artificial Analysis IFBench score for instruction following. Parsed from the public evaluation page JSON-LD dataset.",
        "active": 1,
    },
    {
        "id": "aa_ifbench_output_tokens",
        "name": "AA IFBench Output Tokens",
        "short": "IF Tokens",
        "source": "Artificial Analysis",
        "url": "https://artificialanalysis.ai/evaluations/ifbench",
        "category": "Latency & Cost",
        "metric": "Output tokens/task",
        "higher_is_better": 0,
        "tier": 3,
        "scraper_id": "ArtificialAnalysisIfbenchAdapter",
        "description": "Answer plus reasoning output tokens per IFBench task. Companion efficiency evidence; lower is generally cheaper and faster for equivalent quality.",
        "active": 1,
    },
    {
        "id": "aa_ifbench_cost",
        "name": "AA IFBench Cost",
        "short": "IF Cost",
        "source": "Artificial Analysis",
        "url": "https://artificialanalysis.ai/evaluations/ifbench",
        "category": "Latency & Cost",
        ...
        "tier": 3,
        "scraper_id": "ArtificialAnalysisIfbenchAdapter",
        "description": "Estimated total model cost per IFBench task from Artificial Analysis cost components.",
        "active": 1,
    },
    {
        "id": "aa_ifbench_time",
        "name": "AA IFBench Time",
        "short": "IF Time",
        "source": "Artificial Analysis",
        "url": "https://artificialanalysis.ai/evaluations/ifbench",
        "category": "Latency & Cost",
        ...
        "tier": 3,
        "scraper_id": "ArtificialAnalysisIfbenchAdapter",
        "description": "Weighted average wall-clock minutes per IFBench task, excluding TTFT and execution time where Artificial Analysis documents that boundary.",
        "active": 1,
    },
    {
        "id": "gpqa_diamond",
    ...
    },
    {
        ...
        "tier": 3,
        "scraper_id": "MmmuAdapter",
        "description": "MMMU held-out test overall score when the upstream leaderboard publishes stable model-level test results. Human/random baselines are skipped.",
        "active": 1,
    },
    {
        "id": "mmmu_pro",
        ...
        "tier": 3,
        "scraper_id": "MmmuAdapter",
        "description": "MMMU-Pro overall score when the upstream leaderboard publishes stable model-level pro results. Validation behavior remains unchanged, and human/random baselines are skipped.",
        "active": 1,
    },
    {
    ...
    },
    {
        ...
        "tier": 3,
        "scraper_id": "SwebenchAdapter",
        "description": "Derived from the official SWE-bench Full/Test board using the best single-model system submission per model. Companion split evidence; ranking weights still use Verified first.",
        "active": 1,
    },
    {
        "id": "swebench_lite",
        ...
        "tier": 3,
        "scraper_id": "SwebenchAdapter",
        "description": "Derived from the official SWE-bench Lite board using the best single-model system submission per model. Companion split evidence for smaller issue sets.",
        "active": 1,
    },
    {
        ...
        "tier": 3,
        "scraper_id": "SwebenchAdapter",
        "description": "Derived from the official SWE-bench Multilingual board using the best single-model system submission per model.",
        "active": 1,
    },
    {
        "id": "swebench_multimodal",
        "name": "SWE-bench Multimodal",
        "short": "SWE-MM",
        "source": "SWE-bench team",
        "url": "https://www.swebench.com/#multimodal",
        "category": "Coding",
        "metric": "% Issues Resolved",
        "higher_is_better": 1,
        "tier": 3,
        "scraper_id": "SwebenchAdapter",
        "description": "Derived from the official SWE-bench Multimodal board using the best single-model system submission per model.",
        "active": 1,
    },
    {
        "id": "livecodebench_codegen",
        ...
        "higher_is_better": 1,
        "tier": 2,
        "scraper_id": "LiveCodeBenchAdapter",
        "description": "Code-generation pass@1 aggregated from the official LiveCodeBench default date window. The adapter preserves window, difficulty, platform, release-date, and contamination metadata for review.",
        "active": 1,
    },
    {
        "id": "ifeval",
    ...
    },
    {
        ...
        "name": "Vectara Hallucination Rate",
        "short": "Vectara Halluc.",
        "source": "Vectara",
        "url": "https://github.com/vectara/hallucination-leaderboard",
        "category": "Retrieval & Grounding",
        ...
        "tier": 3,
        "scraper_id": "VectaraHallucinationAdapter",
        "description": "Grounded summarization hallucination rate from the Vectara leaderboard. Lower is better; this remains a faithfulness signal rather than retrieval relevance.",
        "active": 1,
    },
    {
        "id": "rag_answer_rate",
        "name": "Vectara Answer Rate",
        "short": "Vectara Answer",
        "source": "Vectara",
        "url": "https://github.com/vectara/hallucination-leaderboard",
        "category": "Retrieval & Grounding",
        "metric": "Answer Rate %",
        ...
        "tier": 3,
        "scraper_id": "VectaraHallucinationAdapter",
        "description": "Answer-rate companion metric from the Vectara hallucination leaderboard. Useful coverage context for grounded summarization, not a retrieval-quality score.",
        "active": 1,
    },
    {
    ...
    {
        "id": "faithjudge_faithbench_summarization",
        "name": "FaithJudge FaithBench Summarization",
        "short": "FJ FaithBench",
        "source": "Vectara",
        "url": "https://github.com/vectara/FaithJudge#leaderboard",
        "category": "Retrieval & Grounding",
        ...
        "tier": 3,
        "scraper_id": "FaithJudgeAdapter",
        "description": "FaithJudge FaithBench summarization hallucination-rate subtask. Lower is better; useful task-level faithfulness context, not retrieval relevance.",
        "active": 1,
    },
    {
        "id": "faithjudge_ragtruth_summarization",
        "name": "FaithJudge RAGTruth Summarization",
        "short": "FJ RT Sum",
        "source": "Vectara",
        "url": "https://github.com/vectara/FaithJudge#leaderboard",
        "category": "Retrieval & Grounding",
        ...
        "tier": 3,
        "scraper_id": "FaithJudgeAdapter",
        "description": "FaithJudge RAGTruth summarization hallucination-rate subtask. Lower is better; useful task-level faithfulness context, not retrieval relevance.",
        "active": 1,
    },
    {
        "id": "faithjudge_ragtruth_question_answering",
        "name": "FaithJudge RAGTruth QA",
        "short": "FJ RT QA",
        "source": "Vectara",
        "url": "https://github.com/vectara/FaithJudge#leaderboard",
        "category": "Retrieval & Grounding",
        ...
        "tier": 3,
        "scraper_id": "FaithJudgeAdapter",
        "description": "FaithJudge RAGTruth question-answering hallucination-rate subtask. Lower is better; useful task-level faithfulness context, not retrieval relevance.",
        "active": 1,
    },
    {
        "id": "faithjudge_ragtruth_data_to_text",
        "name": "FaithJudge RAGTruth Data-to-Text",
        "short": "FJ RT D2T",
        "source": "Vectara",
        "url": "https://github.com/vectara/FaithJudge#leaderboard",
        "category": "Retrieval & Grounding",
        ...
        "tier": 3,
        "scraper_id": "FaithJudgeAdapter",
        "description": "FaithJudge RAGTruth data-to-text hallucination-rate subtask. Lower is better; useful task-level faithfulness context, not retrieval relevance.",
        "active": 1,
    },
    {
        "id": "mteb_retrieval",
        ...
        "category": "Retrieval & Grounding",
        "metric": "Average main score %",
        "higher_is_better": 1,
        "tier": 2,
        "scraper_id": "MtebAdapter",
        "description": "Average MTEB retrieval task main score for embedding models, sourced from the official embeddings-benchmark/results repository. Used only in embedding/reranking model-role use cases.",
        "active": 1,
    },
    {
        "id": "mteb_reranking",
        ...
        "tier": 2,
        "scraper_id": "MtebAdapter",
        "description": "Average MTEB reranking task main score for reranker-capable models, sourced from the official embeddings-benchmark/results repository. Used only in reranker model-role use cases.",
        "active": 1,
    },
    {
        "id": "mteb_retrieval_reranking",
        ...
        "tier": 2,
        "scraper_id": "MtebAdapter",
        "description": "Combined MTEB retrieval and reranking average for RAG retrieval-sorting model selection. It is intentionally separate from generator-model RAG answer-quality use cases.",
        "active": 1,
    },
    {
        "id": "rteb_finance",
    ...
    {
        "id": "asr_english_short_wer",
        "name": "Open ASR English Short-Form",
        "short": "ASR English",
        ...
        "higher_is_better": 0,
        "tier": 2,
        "scraper_id": "OpenAsrLeaderboardAdapter",
        "description": "Average short-form English word error rate from the Hugging Face Open ASR Leaderboard. Lower is better.",
        "active": 1,
    },
    {
        "id": "asr_multilingual_wer",
        "name": "Open ASR Multilingual",
        "short": "ASR Multi",
        "source": "Hugging Face Open ASR Leaderboard",
        "url": "https://huggingface.co/datasets/Steveeeeeeen/multilingual_evals",
        "category": "Speech & Audio",
        "metric": "Average WER",
        "higher_is_better": 0,
        "tier": 2,
        "scraper_id": "OpenAsrLeaderboardAdapter",
        "description": "Published multilingual average word error rate from the Hugging Face Open ASR Leaderboard. Lower is better.",
        "active": 1,
    },
    {
        "id": "asr_longform_wer",
        "name": "Open ASR Long-Form",
        "short": "ASR Long",
        "source": "Hugging Face Open ASR Leaderboard",
        "url": "https://huggingface.co/datasets/Steveeeeeeen/leaderboard_longform",
        "category": "Speech & Audio",
        "metric": "Average WER",
        "higher_is_better": 0,
        "tier": 2,
        "scraper_id": "OpenAsrLeaderboardAdapter",
        "description": "Published long-form average word error rate from the Hugging Face Open ASR Leaderboard. Lower is better.",
        "active": 1,
    },
    {
        "id": "asr_realtime_factor",
        "name": "Open ASR Real-Time Factor",
        "short": "ASR RTFx",
        "source": "Hugging Face Open ASR Leaderboard",
        ...
        "tier": 3,
        "scraper_id": "OpenAsrLeaderboardAdapter",
        "description": "Best reported real-time factor across imported Open ASR Leaderboard splits. Higher is faster and should be read as companion evidence to WER.",
        "active": 1,
    },
    {
        "id": "aa_tts_quality_elo",
        "name": "AA TTS Quality Elo",
        "short": "AA TTS Elo",
        "source": "Artificial Analysis",
        "url": "https://artificialanalysis.ai/text-to-speech/models",
        "category": "Speech & Audio",
        "metric": "Speech Arena Elo",
        "higher_is_better": 1,
        "tier": 2,
        "scraper_id": "ArtificialAnalysisTtsAdapter",
        "description": "Artificial Analysis Text to Speech Arena Elo quality score from blind listener preferences. Higher is better.",
        "active": 1,
    },
    {
        "id": "aa_tts_generation_time",
        "name": "AA TTS Generation Time",
        "short": "AA TTS Time",
        "source": "Artificial Analysis",
        "url": "https://artificialanalysis.ai/text-to-speech/models",
        "category": "Speech & Audio",
        "metric": "Seconds per ~500 characters",
        "higher_is_better": 0,
        "tier": 2,
        "scraper_id": "ArtificialAnalysisTtsAdapter",
        "description": "Derived generation-time estimate from Artificial Analysis Text to Speech Characters Per Second data using a 500-character prompt. Lower is better.",
        "active": 1,
    },
    {
        "id": "aa_tts_price_per_1m_chars",
        "name": "AA TTS Price per 1M Characters",
        "short": "AA TTS Price",
        "source": "Artificial Analysis",
        "url": "https://artificialanalysis.ai/text-to-speech/models",
        "category": "Speech & Audio",
        "metric": "USD / 1M characters",
        "higher_is_better": 0,
        "tier": 2,
        "scraper_id": "ArtificialAnalysisTtsAdapter",
        "description": "Artificial Analysis Text to Speech representative endpoint price per 1M input characters. Lower is better.",
        "active": 1,
    },
    {
        "id": "terminal_bench",
    ...
    {
        "id": "ailuminate_en_us",
        "name": "AILuminate en-US",
        "short": "Safety en",
        "source": "MLCommons",
        "url": "https://ailuminate.mlcommons.org/benchmarks/general_purpose_ai_chat/1.0-en_us-official-ensemble",
        "category": "Safety & Compliance",
        "metric": "Grade (0-100)",
        "higher_is_better": 1,
        "tier": 3,
        "scraper_id": "AILuminateAdapter",
        "description": "AILuminate public grade restricted to the en_us locale surface. Companion evidence only; current safety rankings keep the aggregate grade.",
        "active": 1,
    },
    {
        "id": "ailuminate_fr_fr",
        "name": "AILuminate fr-FR",
        "short": "Safety fr",
        "source": "MLCommons",
        "url": "https://ailuminate.mlcommons.org/benchmarks/general_purpose_ai_chat/1.0-fr_fr-official-ensemble",
        "category": "Safety & Compliance",
        "metric": "Grade (0-100)",
        "higher_is_better": 1,
        "tier": 3,
        "scraper_id": "AILuminateAdapter",
        "description": "AILuminate public grade restricted to the fr_fr locale surface. Companion evidence only; coverage is currently much smaller than en_us.",
        "active": 1,
    },
    {
        "id": "ailuminate_ai_systems",
        "name": "AILuminate AI Systems",
        "short": "Safety Sys",
        "source": "MLCommons",
        "url": "https://ailuminate.mlcommons.org/benchmarks/",
        "category": "Safety & Compliance",
        ...
        "tier": 3,
        "scraper_id": "AILuminateAdapter",
        "description": "AILuminate public grade restricted to the AI Systems table, preserving moderated/system-level evidence separately from bare model evidence.",
        "active": 1,
    },
    {
        "id": "ailuminate_bare_models",
        "name": "AILuminate Bare Models",
        "short": "Safety Bare",
        "source": "MLCommons",
        "url": "https://ailuminate.mlcommons.org/benchmarks/",
        "category": "Safety & Compliance",
        ...
        "tier": 3,
        "scraper_id": "AILuminateAdapter",
        "description": "AILuminate public grade restricted to the Bare Models table, preserving base-model safety evidence separately from system-level results.",
        "active": 1,
    },
    {
        "id": "aa_speed",
    ...
    {
        "id": "chatbot_arena",
        "name": "Arena Text Overall (Style Controlled)",
        "short": "Arena Text SC",
        "source": "LM Arena",
        ...
        "description": "Backward-compatible benchmark ID mapped to the official style-controlled Text Overall Bradley-Terry score.",
        "active": 1,
    },
    *[
        {
        ...
        for benchmark_id, name, short, category, metric, description in (
        ("chatbot_arena_text_raw", "Arena Text Overall (Raw)", "Arena Text", "General Quality", "Arena Score", "Official non-style-controlled Text Overall Bradley-Terry score."),
        ("chatbot_arena_coding", "Arena Text Coding (Style Controlled)", "Arena Coding", "Coding", "Arena Score", "Official style-controlled Text coding category score."),
        ("chatbot_arena_instruction_following", "Arena Text Instruction Following (Style Controlled)", "Arena IFollow", "General Quality", "Arena Score", "Official style-controlled Text instruction-following category score."),
        ("chatbot_arena_multi_turn", "Arena Text Multi-turn (Style Controlled)", "Arena Multi", "General Quality", "Arena Score", "Official style-controlled Text multi-turn category score."),
        ("chatbot_arena_expert", "Arena Text Expert (Style Controlled)", "Arena Expert", "General Quality", "Arena Score", "Official style-controlled Text expert-prompts category score."),
        ("chatbot_arena_finance_business", "Arena Text Finance and Business (Style Controlled)", "Arena Finance", "Domain Knowledge", "Arena Score", "Official style-controlled business, management, and financial-operations category score."),
        ("chatbot_arena_legal_government", "Arena Text Legal and Government (Style Controlled)", "Arena Legal", "Domain Knowledge", "Arena Score", "Official style-controlled legal and government category score."),
        ("chatbot_arena_software_it", "Arena Text Software and IT (Style Controlled)", "Arena IT", "Coding", "Arena Score", "Official style-controlled software and IT services category score."),
        ("chatbot_arena_webdev", "Arena WebDev Overall", "Arena WebDev", "Coding", "Arena Score", "Official WebDev Overall Bradley-Terry score."),
        ("chatbot_arena_agent", "Arena Agent Overall", "Arena Agent", "Agentic", "IPS Success Rate", "Official inverse-propensity-scored Agent success rate."),
        ("chatbot_arena_vision", "Arena Vision Overall (Style Controlled)", "Arena Vision", "Multimodal", "Arena Score", "Official style-controlled Vision Overall Bradley-Terry score."),
        ("chatbot_arena_document", "Arena Document Overall (Style Controlled)", "Arena Docs", "Document", "Arena Score", "Official style-controlled Document Overall Bradley-Terry score."),
        ("chatbot_arena_search", "Arena Search Overall (Style Controlled)", "Arena Search", "Search", "Arena Score", "Official style-controlled Search Overall Bradley-Terry score."),
        )
    ],
    {
        ...
        "higher_is_better": 1,
        "tier": 2,
        "scraper_id": "LiveBenchAdapter",
        "description": "Global average from official LiveBench public static leaderboard category averages for the latest publicly released question set.",
        "active": 1,
    },
    {
        ...
        "tier": 2,
        "scraper_id": "LiveBenchAdapter",
        "description": "Reasoning category average from official LiveBench public static leaderboard task scores.",
        "active": 1,
    },
    {
        "id": "livebench_coding",
        ...
        "tier": 2,
        "scraper_id": "LiveBenchAdapter",
        "description": "Coding category average from official LiveBench public static leaderboard task scores.",
        "active": 1,
    },
    {
        ...
        "tier": 2,
        "scraper_id": "LiveBenchAdapter",
        "description": "Agentic coding category average from official LiveBench public static leaderboard task scores.",
        "active": 1,
    },
    {
        "id": "livebench_math",
        "name": "LiveBench Mathematics",
        "short": "LB Math",
        "source": "LiveBench",
        "url": "https://livebench.ai/",
        "category": "Reasoning & Math",
        ...
        "tier": 2,
        "scraper_id": "LiveBenchAdapter",
        "description": "Mathematics category average from official LiveBench public static leaderboard task scores.",
        "active": 1,
    },
    {
        ...
        "tier": 2,
        "scraper_id": "LiveBenchAdapter",
        "description": "Data analysis category average from official LiveBench public static leaderboard task scores.",
        "active": 1,
    },
    {
        ...
        "tier": 2,
        "scraper_id": "LiveBenchAdapter",
        "description": "Language category average from official LiveBench public static leaderboard task scores.",
        "active": 1,
    },
    {
        ...
        "tier": 2,
        "scraper_id": "LiveBenchAdapter",
        "description": "Instruction-following category average from official LiveBench public static leaderboard task scores.",
        "active": 1,
    },
    {
        "id": "bfcl_overall",
    ...
    },
    {
        ...
        "higher_is_better": 1,
        "tier": 2,
        "scraper_id": "BigCodeBenchAdapter",
        "description": "Official BigCodeBench Full Set average of instruct and complete Pass@1 scores using greedy decoding.",
        "active": 1,
    },
    {
        "id": "bigcodebench_full_instruct",
        "name": "BigCodeBench Full Instruct",
        "short": "BCB-F-I",
        "source": "BigCodeBench",
        "url": "https://bigcode-bench.github.io/",
        "category": "Coding",
        ...
        "tier": 3,
        "scraper_id": "BigCodeBenchAdapter",
        "description": "Official BigCodeBench Full Set instruct Pass@1 score.",
        "active": 1,
    },
    {
        "id": "bigcodebench_full_complete",
        "name": "BigCodeBench Full Complete",
        "short": "BCB-F-C",
        "source": "BigCodeBench",
        "url": "https://bigcode-bench.github.io/",
        "category": "Coding",
        ...
        "tier": 3,
        "scraper_id": "BigCodeBenchAdapter",
        "description": "Official BigCodeBench Full Set complete Pass@1 score.",
        "active": 1,
    },
    {
        ...
        "tier": 2,
        "scraper_id": "BigCodeBenchAdapter",
        "description": "Official BigCodeBench Hard subset average of instruct and complete Pass@1 scores.",
        "active": 1,
    },
    {
        "id": "bigcodebench_hard_instruct",
        ...
        "tier": 3,
        "scraper_id": "BigCodeBenchAdapter",
        "description": "Official BigCodeBench Hard subset instruct Pass@1 score.",
        "active": 1,
    },
    {
        "id": "bigcodebench_hard_complete",
        ...
        "tier": 3,
        "scraper_id": "BigCodeBenchAdapter",
        "description": "Official BigCodeBench Hard subset complete Pass@1 score.",
        "active": 1,
    },
    {
        "id": "helm_capabilities_mean",
        "name": "HELM Capabilities Mean",
        "short": "HELM-C",
        ...
        "higher_is_better": 1,
        "tier": 2,
        "scraper_id": "HelmCapabilitiesAdapter",
        "description": "Official HELM Capabilities core-scenarios mean accuracy across MMLU-Pro, GPQA, IFEval, WildBench, and Omni-MATH.",
        "active": 1,
    },
    {
        "id": "helm_capabilities_mmlu_pro",
        "name": "HELM Capabilities MMLU-Pro",
        "short": "HELM-MMLU",
        "source": "Stanford CRFM",
        "url": "https://crfm.stanford.edu/helm/capabilities/latest/",
        "category": "Reasoning & Math",
        ...
        "tier": 3,
        "scraper_id": "HelmCapabilitiesAdapter",
        "description": "Official HELM Capabilities MMLU-Pro chain-of-thought correctness component.",
        "active": 1,
    },
    {
        "id": "helm_capabilities_gpqa",
        "name": "HELM Capabilities GPQA",
        "short": "HELM-GPQA",
        "source": "Stanford CRFM",
        "url": "https://crfm.stanford.edu/helm/capabilities/latest/",
        "category": "Reasoning & Math",
        ...
        "tier": 3,
        "scraper_id": "HelmCapabilitiesAdapter",
        "description": "Official HELM Capabilities GPQA chain-of-thought correctness component.",
        "active": 1,
    },
    {
        "id": "helm_capabilities_ifeval",
        "name": "HELM Capabilities IFEval",
        "short": "HELM-IFE",
        "source": "Stanford CRFM",
        "url": "https://crfm.stanford.edu/helm/capabilities/latest/",
        "category": "Instruction Following",
        ...
        "tier": 3,
        "scraper_id": "HelmCapabilitiesAdapter",
        "description": "Official HELM Capabilities IFEval strict accuracy component.",
        "active": 1,
    },
    {
        "id": "helm_capabilities_wildbench",
        "name": "HELM Capabilities WildBench",
        "short": "HELM-WB",
        "source": "Stanford CRFM",
        "url": "https://crfm.stanford.edu/helm/capabilities/latest/",
        "category": "General Quality",
        ...
        "tier": 3,
        "scraper_id": "HelmCapabilitiesAdapter",
        "description": "Official HELM Capabilities WildBench score component.",
        "active": 1,
    },
    {
        "id": "helm_capabilities_omni_math",
        "name": "HELM Capabilities Omni-MATH",
        "short": "HELM-OM",
        "source": "Stanford CRFM",
        "url": "https://crfm.stanford.edu/helm/capabilities/latest/",
        "category": "Reasoning & Math",
        ...
        "tier": 3,
        "scraper_id": "HelmCapabilitiesAdapter",
        "description": "Official HELM Capabilities Omni-MATH accuracy component.",
        "active": 1,
    },
    {
        "id": "taubench_text_mean",
        "name": "tau-bench Text Mean",
        "short": "tau-text",
        "source": "Sierra",
        ...
        "higher_is_better": 1,
        "tier": 2,
        "scraper_id": "TaubenchAdapter",
        "description": "Mean pass^1 score across the current complete text tau-bench domain set. Secondary agent-system evidence, not a pure model-only eval.",
        "active": 1,
    },
    {
        "id": "taubench_text_airline",
        "name": "tau-bench Text Airline",
        "short": "tau-air",
        "source": "Sierra",
        "url": "https://taubench.com/",
        "category": "Agentic & Tool Use",
        ...
        "tier": 2,
        "scraper_id": "TaubenchAdapter",
        "description": "Text tau-bench airline-domain pass^1 score from current standard single-model submissions.",
        "active": 1,
    },
    {
        "id": "taubench_text_retail",
        "name": "tau-bench Text Retail",
        "short": "tau-ret",
        "source": "Sierra",
        "url": "https://taubench.com/",
        "category": "Agentic & Tool Use",
        ...
        "tier": 2,
        "scraper_id": "TaubenchAdapter",
        "description": "Text tau-bench retail-domain pass^1 score from current standard single-model submissions.",
        "active": 1,
    },
    {
        "id": "taubench_text_telecom",
        "name": "tau-bench Text Telecom",
        "short": "tau-tel",
        "source": "Sierra",
        "url": "https://taubench.com/",
        "category": "Agentic & Tool Use",
        ...
        "tier": 2,
        "scraper_id": "TaubenchAdapter",
        "description": "Text tau-bench telecom-domain pass^1 score from current standard single-model submissions.",
        "active": 1,
    },
    {
        "id": "taubench_text_banking_knowledge",
        "name": "tau-bench Text Banking Knowledge",
        "short": "tau-bank",
        "source": "Sierra",
        "url": "https://taubench.com/",
        "category": "Retrieval & Grounding",
        ...
        "tier": 2,
        "scraper_id": "TaubenchAdapter",
        "description": "Text tau-bench banking knowledge-domain pass^1 score, including retrieval configuration metadata when provided.",
        "active": 1,
    },
    {
        "id": "taubench_voice_mean",
        "name": "tau-bench Voice Mean",
        "short": "tau-voice",
        "source": "Sierra",
        "url": "https://taubench.com/",
        "category": "Agentic & Tool Use",
        ...
        "tier": 3,
        "scraper_id": "TaubenchAdapter",
        "description": "Mean pass^1 score across the current complete voice tau-bench domain set. Secondary audio-agent evidence.",
        "active": 1,
    },
    {
        "id": "taubench_voice_airline",
        "name": "tau-bench Voice Airline",
        "short": "tau-vair",
        "source": "Sierra",
        "url": "https://taubench.com/",
        "category": "Agentic & Tool Use",
        ...
        "tier": 3,
        "scraper_id": "TaubenchAdapter",
        "description": "Voice tau-bench airline-domain pass^1 score from current standard single-model audio submissions.",
        "active": 1,
    },
    {
        "id": "taubench_voice_retail",
        "name": "tau-bench Voice Retail",
        "short": "tau-vret",
        "source": "Sierra",
        "url": "https://taubench.com/",
        "category": "Agentic & Tool Use",
        ...
        "tier": 3,
        "scraper_id": "TaubenchAdapter",
        "description": "Voice tau-bench retail-domain pass^1 score from current standard single-model audio submissions.",
        "active": 1,
    },
    {
        "id": "taubench_voice_telecom",
        "name": "tau-bench Voice Telecom",
        "short": "tau-vtel",
        "source": "Sierra",
        "url": "https://taubench.com/",
        "category": "Agentic & Tool Use",
        ...
        "tier": 3,
        "scraper_id": "TaubenchAdapter",
        "description": "Voice tau-bench telecom-domain pass^1 score from current standard single-model audio submissions.",
        "active": 1,
    },
    {
        "id": "ragtruth_hallucination_rate",
        "name": "RAGTruth Hallucination Rate",
        "short": "RAGTruth",
        ...
        "higher_is_better": 0,
        "tier": 3,
        "scraper_id": "RagtruthAdapter",
        "description": "Official RAGTruth held-out test split response-level hallucination rate across Summary, QA, and Data-to-text tasks. Lower is better; coverage is historical.",
        "active": 1,
    },
    {
        "id": "ragtruth_summary_hallucination_rate",
        "name": "RAGTruth Summarization Hallucination Rate",
        "short": "RAGTruth-Sum",
        "source": "Particle Media",
        "url": "https://github.com/ParticleMedia/RAGTruth",
        "category": "Retrieval & Grounding",
        ...
        "tier": 3,
        "scraper_id": "RagtruthAdapter",
        "description": "Official RAGTruth held-out summarization response-level hallucination rate. Lower is better.",
        "active": 1,
    },
    {
        "id": "ragtruth_qa_hallucination_rate",
        "name": "RAGTruth QA Hallucination Rate",
        "short": "RAGTruth-QA",
        "source": "Particle Media",
        "url": "https://github.com/ParticleMedia/RAGTruth",
        "category": "Retrieval & Grounding",
        ...
        "tier": 3,
        "scraper_id": "RagtruthAdapter",
        "description": "Official RAGTruth held-out question-answering response-level hallucination rate. Lower is better.",
        "active": 1,
    },
    {
        "id": "ragtruth_data_to_text_hallucination_rate",
        "name": "RAGTruth Data-to-text Hallucination Rate",
        "short": "RAGTruth-D2T",
        "source": "Particle Media",
        "url": "https://github.com/ParticleMedia/RAGTruth",
        "category": "Retrieval & Grounding",
        ...
        "tier": 3,
        "scraper_id": "RagtruthAdapter",
        "description": "Official RAGTruth held-out data-to-text response-level hallucination rate. Lower is better.",
        "active": 1,
    },
]
...
USE_CASES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "label": "Voice to Text",
        "icon": "🎙️",
        "description": "Speech recognition, transcription quality, multilingual ASR, and long-form voice capture",
        "segment": "core",
        "status": "preview",
        ...
        "required_benchmarks": [],
        "benchmark_notes": {
            "asr_english_short_wer": "Primary short-form English transcription quality signal from Open ASR.",
            "asr_multilingual_wer": "Multilingual transcription quality from Open ASR.",
            "asr_longform_wer": "Long-form transcription quality from Open ASR.",
            "asr_realtime_factor": "Companion speed evidence; quality remains anchored on WER.",
        },
        "weights": {
            "asr_english_short_wer": 0.45,
            "asr_multilingual_wer": 0.25,
            "asr_longform_wer": 0.20,
            "asr_realtime_factor": 0.10,
        },
    },
    {
        "id": "text_to_speech",
        ...
        "icon": "🔊",
        "description": "Speech synthesis quality, generation time, and character-priced voice output",
        "segment": "core",
        "status": "preview",
        "model_roles": ["text_to_speech"],
        "min_coverage": 0.3,
        "required_benchmarks": ["aa_tts_quality_elo"],
        "benchmark_notes": {
            "aa_tts_quality_elo": "Primary Text to Speech synthesis-quality signal from Artificial Analysis Speech Arena listener preference Elo.",
            "aa_tts_generation_time": "Operational latency companion signal derived from Artificial Analysis characters-per-second measurements.",
            "aa_tts_price_per_1m_chars": "Representative endpoint price per 1M input characters from Artificial Analysis.",
        },
        "weights": {
            "aa_tts_quality_elo": 0.70,
            "aa_tts_generation_time": 0.15,
            "aa_tts_price_per_1m_chars": 0.15,
        },
    },
    {
    ...
    },
    {
        ...
        "icon": "🔎",
        "description": "Embedding-model selection for semantic retrieval, vector search, and first-stage RAG recall",
        "segment": "enterprise",
        "status": "preview",
        "model_roles": ["embedding"],
        "min_coverage": 0.5,
        "required_benchmarks": ["mteb_retrieval"],
        "benchmark_notes": {
    ...
    },
    {
        ...
        "icon": "↕",
        "description": "Reranker-capable model selection for second-stage RAG ordering and search-result refinement",
        "segment": "enterprise",
        "status": "preview",
        "model_roles": ["reranker"],
        "min_coverage": 0.5,
        "required_benchmarks": ["mteb_reranking"],
        "benchmark_notes": {
            "mteb_reranking": "Primary reranking quality signal from MTEB task-level main scores.",
            "mteb_retrieval_reranking": "Optional blended context across retrieval and reranking tasks.",
        },
        "weights": {
            "mteb_reranking": 0.80,
        ...
        [
            {
                **row,
                ...
                "model_roles_json": row.get("model_roles_json") or json.dumps(["generator"], ensure_ascii=True),
            }
            for row in MODELS
        ],
        preserve_columns=(
